...
public class CartController {
    ...
    public void addCarts(ArrayList<Book> myArr) {
        System.out.println("==========================");
        try (
            ...
            do {
                ...
                do {
                    ...
                    if ((rs.getInt("BookId") == cartBookID) && (rs.getInt("qty") > 0 && rs.getInt("status") != 3 )) {
                        myArr.add(new Book(rs.getInt("BookId"), rs.getString("Name"),
    ...
    public void checkOut(ArrayList<Book> myArr){
        System.out.println("==========================");
    ...
    public void showBills(ArrayList<Book> myArr) {
        System.out.println("==========================");
